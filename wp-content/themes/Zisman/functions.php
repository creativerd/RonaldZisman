...
function pz_setup() {
	...
	add_image_size( 'full-width', 1600, 1168, true );
...
function pz_scripts() {
	...
	// modernizer
	wp_enqueue_script( 'pz-modernizer', get_template_directory_uri() . '/library/js/vendors/modernizr.js', array(), '16-12-2014', false );

	// custom maion script
	wp_enqueue_script( 'pz-script', get_template_directory_uri() . '/library/js/pz-main.js', array('jquery'), '16-12-2014', true );
}
